...
//       const { username, password, weight, height, age, gender, aim, goa } = req.body;
...
//       const user = new User({ username: username, password: hashPassword, weight: weight, height: height, age: age, gender: gender, aim: aim })
